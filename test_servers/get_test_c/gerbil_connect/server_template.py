...
def get_test_c_raw_text(raw_text):
    testc_item = {}
    testc_item["raw_text"] = raw_text
    test_c_raws.append(testc_item)

    with open('all_raws.pkl', 'wb') as f:
        pickle.dump(test_c_raws, f)
...
class GerbilAnnotator:
    ...
    def annotate(self, nif_collection, **kwargs):
        ...
        for annotation in get_test_c_raw_text(raw_text):
