...
def dict_entity_linking_model(raw_text):
    output = raw_text_to_output[raw_text]
...
class GerbilAnnotator:
    ...
    def annotate(self, nif_collection, **kwargs):
        ...
        for annotation in dict_entity_linking_model(raw_text):
...
with open("dict.pkl", 'rb') as file:
    ...
    raw_text_to_output = pickle.load(file)
